...
void InstructionMemory::Instruction::loadBitstream(Config& bitstream, std::string key) {
...
void InstructionMemory::Instruction::decode(std::string type) {
    if (type == "NOP") {
...
void InstructionMemory::Instruction::setStaticParam(Location& loc, Word param) {
